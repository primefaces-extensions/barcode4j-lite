...
public class EAN128LogicImpl { //extends Code128LogicImpl{
    ...
    public void generateBarcodeLogic(ClassicBarcodeLogicHandler logic, String msg) {
        ...
        for (int j : encodedMsg) {
            c128.encodeChar(logic, j);
        }
    ...
    public int addAI(String msg, int offset, EAN128AI ai) {
        ...
        humanReadableMsg.append(msg, offset, offset + lenID);
        code128Msg.append(msg, offset, offset + lenID); //BUG fixed 15.08!!
        if (!omitBrackets) {
            humanReadableMsg.append(')');
        }
